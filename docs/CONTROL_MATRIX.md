...
|---|---|---|---|---|---|---|
| CTL-001 | Enforce mission-scoped authority | NIST AI RMF, SOC 2, OWASP Agentic | Capability tokens, Guard decisions, Guard receipts | Mission OS / Guard | Implemented foundation | Build 3 adds schema/policy primitives; runtime service deferred. |
...
| CTL-003 | Capture replayable evidence | ISO 42001, SOC 2 | Receipt ledger, Guard decision receipts, artifacts | Receipts / Guard | Implemented foundation | Guard receipt shape added; full ledger pending. |
...
| CTL-009 | Block or escalate hard-stop actions | NIST AI RMF, OWASP Agentic, SOC 2 | Guard reason codes, matched hard stops, receipts | Guard | Implemented foundation | Build 3 covers production deploy, money movement, raw secret access, protected branch mutation, force push, and CI weakening cases. |
