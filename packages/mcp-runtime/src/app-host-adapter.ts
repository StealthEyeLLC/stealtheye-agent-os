...
export function assertRuntimeToolDescriptorSafe(tool: RuntimeToolDescriptor): boolean {
  ...
  const previewSafe = tool.safety.live === false && (tool.safety.liveCapabilityStatus === "disabled" || tool.safety.liveCapabilityStatus === "fixture_only") && (tool.safety.previewOnly || tool.safety.fixtureOnly);
