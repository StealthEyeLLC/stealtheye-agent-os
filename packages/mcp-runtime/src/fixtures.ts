export const MCP_RUNTIME_ID = "runtime:stealtheye-agent-os:build-11:local-dev-readonly-repo-status";
...
export const MCP_RUNTIME_FORBIDDEN_TOOL_KEYWORDS = ["delete","commit","pull_request","pr.create","pr.update","issue.update","deploy","payment","purchase","browser.click","browser.type","workflow.dispatch","ci.rerun","secret","credential","write_branch_files"] as const;
